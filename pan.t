...
{	Trans *T;
	...
	T = trans[0][15] = settr(14,0,0,0,0,"DO", 0, 2, 0);
	    T->nxt	= settr(14,0,7,0,0,"DO", 0, 2, 0);
/*->*/	trans[0][7]	= settr(6,32,14,3,3,"D_STEP", 1, 2, 0);
/*->*/	trans[0][14]	= settr(13,32,15,4,4,"D_STEP", 1, 2, 0);
	trans[0][17]	= settr(16,0,18,1,0,"break", 0, 2, 0);
	trans[0][18]	= settr(17,0,0,5,5,"-end-", 0, 3500, 0);
	/* np_ demon: */
